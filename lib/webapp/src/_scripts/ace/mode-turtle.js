ace.define("ace/mode/turtle_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(ace_require, exports, module) {
"use strict";
...
var TurtleHighlightRules = function() {
    ...
    this.$rules = {
        ...
        "#qnames": [{
            ...
            token: [ 'constant.other.turtle', 'keyword.operator.punctuation.turtle', 'entity.name.function.turtle' ],
...
ace.define("ace/mode/turtle",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/turtle_highlight_rules","ace/mode/folding/cstyle"], function(ace_require, exports, module) {
"use strict";

var oop = ace_require("../lib/oop");
var TextMode = ace_require("./text").Mode;
var TurtleHighlightRules = ace_require("./turtle_highlight_rules").TurtleHighlightRules;
